      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
          {topics.map((topic: any) => (
            <div
              key={topic.title}
              className="flex flex-col overflow-hidden shadow-lg topic-item pb-4 border-r-4"
            >
              <div className="flex flex-1 flex-col justify-between p-6">
                <div className="flex-1">
                  <div className="mt-2 block pb-8">
                    ...
                    <p className="mt-3 text-xs text-white pb-6">
                      {topic.description}
                    </p>
                  </div>
                  <div className="mt-2 block absolute bottom-8">
                    <a className="btn text-white add-btn" href="#">
                      Add
                    </a>
                  </div>
                </div>
